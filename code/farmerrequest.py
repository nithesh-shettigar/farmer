...
<h1 id="site-name"><a href="#">request for  market</a></h1>
...
<form  action="farmerrequestdone.py?user=%s&market=%s" method="post" id="login-form"><input type="hidden" name="csrfmiddlewaretoken" value="N3XJ80FkKF6aUL7mfTzg1dc6pmhTZ6gOZ1Vh0qEE0Z6MLUEwwSzo49UAStYbiHnl">
 

  <div class="form-row">
    
<div class="col-sm-6">
                <label class="required" for="id_username" >choose item</label><br>                 
...
print('''
  ...
  <div class="form-row">
    ...
    <label class="required" for="id_username">rate</label> <input type="text" name="rate" autofocus required id="id_username">
  </div>
 
   <div class="form-row">
    
    <label class="required" for="id_username">quantity</label> <input type="text" name="quantity" autofocus required id="id_username">
  </div>
