...
if flag==1 and flag1==1:
	try:
		...
		sql="insert into admin values('%s','%s','%s','%s','%s')"%(marketid,username,password,marketname,location)
		cursor.execute(sql);
		db.commit()
		print('''<center>
...
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="margin:100;" >
                    <div class="card">
						...
						<br><br>
						<a href="marketlogin.html" class="btn-large waves-effect waves-light">go back to login page</a>
						</div>
                    </div>
                </div>
