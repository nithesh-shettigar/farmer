...
db1=mysql.connector.connect(user="root",password="",host="localhost",database="transport")
...
<h1 id="site-name"><a href="#">transport update</a></h1>
...
<form  action="transportupdatedone.py?user=%s" method="post" id="login-form"><input type="hidden" name="csrfmiddlewaretoken" value="N3XJ80FkKF6aUL7mfTzg1dc6pmhTZ6gOZ1Vh0qEE0Z6MLUEwwSzo49UAStYbiHnl">
...
print('''
  ...
  <div class="form-row">
    ...
    <label class="required" for="id_username">no of vehicles:</label> <input type="number" name="vehiclecount" autofocus required id="id_username">
  </div>
